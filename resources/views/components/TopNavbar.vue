    ...
    <header class="mb-5">
        <nav class="navbar fixed-top bg-light shadow py-1">
            <div class="container-fluid">
                ...
                <div class="dropdown">
                    <!-- @if(Session::get('user')) -->
                        ...
                        <div class="dropdown-menu dropdown-menu-start shadow bg-light" aria-labelledby="menu">
                            <a class="dropdown-item text-dark my-2" href="/attendanceBook'">
                            ...
                            <!-- @if(Session::get('user')->isAdmin) -->
                                <a class="dropdown-item text-dark my-2" href="/manageUsers">
                                    <div class="row flex-nowrap">
                                        <div class="col-2 text-center"><i class="fas fa-users"></i></div>
                                        <div class="col-10">Manage Users</div>
                                    </div>
                                </a>
                                <a class="dropdown-item text-dark my-2" href="/manageDevices">
                                    <div class="row flex-nowrap">
                ...
                <div>
                    <a class="btn btn-link text-dark py-0 text-decoration-none" href="/" type="button">
