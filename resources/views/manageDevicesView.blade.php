			...
			<div class="card bg-light text-dark shadow">
				...
				<div class="card-body">
					<form method="post" action="{{ url('/saveUser') }}">
						...
						<div class="mb-3">
							<label for="deciveId" class="form-label">Device ID</label>
							<input type="text" class="form-control form-control-sm" id="deciveId" name="deciveId" required>
						</div>
						<div class="mb-3">
...
<script>
	function editable(id)
	{
		...
		document.querySelector("#deciveId").value = tableCell[2].innerHTML;
